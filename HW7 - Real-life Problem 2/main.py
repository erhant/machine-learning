...
target1_pred, target1_auroc = run('hw07_target1_training_data.csv', 'hw07_target1_training_label.csv', 'hw07_target1_test_data.csv')
target2_pred, target2_auroc = run('hw07_target2_training_data.csv', 'hw07_target2_training_label.csv', 'hw07_target2_test_data.csv')
target3_pred, target3_auroc = run('hw07_target3_training_data.csv', 'hw07_target3_training_label.csv', 'hw07_target3_test_data.csv')
